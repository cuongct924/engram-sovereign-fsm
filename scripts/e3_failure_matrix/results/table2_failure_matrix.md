...
| S2 BTC congestion (settled) | healthy | healthy | healthy | ANCHORED | enabled | continuous (11 blocks, 0 halts) |
| S3 DA unavailable (settled) | healthy | healthy | healthy | ANCHORED | enabled | continuous (32 blocks, 0 halts) |
| S4 P2P eclipse partial (settled) | healthy | healthy | unhealthy | SOVEREIGN | locked | continuous (28 blocks, 0 halts) |
...
| S7 Recovery (settled) | healthy | healthy | healthy | ANCHORED | enabled | continuous (5 blocks, 0 halts) |
