...
func TestMain(m *testing.M) {
	...
	if err == nil {
		f.WriteString("# E2 Fault-Injection Results\n\n")
		f.WriteString("Generated by `go test ./tests/e2e/...` -- tests/e2e/harness.go drives x/sovereignty's\n")
		f.WriteString("real BeginBlocker in-process against mock BTC/DA/P2P sensors (no CometBFT node, no Docker).\n\n")
		f.WriteString("| Scenario | time_to_fallback | recovery_time | withdrawal_blocked_blocks | flapping_count | total_transitions |\n")
		f.WriteString("|---|---:|---:|---:|---:|---:|\n")
		f.Close()
	}
	os.Exit(m.Run())
