...
// ForcedTxQueueSlice reads the full forced_tx_queue into a slice for use
// with types.IsCensoring/NextIgnoredRounds (spec/core/EngramTendermint.tla's
// forced_tx_queue, a set, is stored as a collections.KeySet here).
