...
EXTENDS MC_EclipseForgedProposalSafety_Apalache
...
ConstInit ==
  ByzantineNodes = {"n1"}
    ...
    /\ Nodes = { "n1", "n2", "n3", "n4" }
    /\ PRECISION = 1
    /\ Proposer = SetAsFun({ <<0, "n1">>, <<1, "n2">>, <<2, "n1">> })
    /\ RESET_TIME = 2
...
State0 ==
  ByzantineNodes = {"n1"}
    ...
    /\ avg_peer_tenure = 1
    /\ begin_round = SetAsFun({ <<0, 0>>, <<1, 2>>, <<2, 2>> })
    /\ blacklisted_peers = {}
    /\ decision
      = SetAsFun({ <<
          "n2", [prop |->
    ...
    /\ local_clock = SetAsFun({ <<"n2", 0>>, <<"n3", 1>>, <<"n4", 0>> })
          ...
          0, {[id |->
            ...
            proposal |->
              [btc_receipt |->
                ...
                da_receipt |->
                  [attestation |-> FALSE, published_block_height |-> 0],
...
InvariantViolation == action = "ByzantineForgedFSMState"

================================================================================
(* Created by Apalache on Mon Aug 10 09:34:39 ICT 2026 *)
